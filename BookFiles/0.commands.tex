...
\renewcommand{\thetheo}{\arabic{chapter}.\arabic{point}}
...
% Both conditions %
\mdfsetup{
    innertopmargin=3pt,linecolor=blue!30,
...
\renewcommand{\thelem}{\arabic{eqtn}.\arabic{chapter}}
...
\renewcommand{\theprf}{\arabic{example}.\arabic{chapter}}
...
\newcounter{code}[chapter]\setcounter{code}{0}
\renewcommand{\theprf}{\arabic{code}.\arabic{chapter}}
