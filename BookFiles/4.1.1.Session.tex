...
\textbf{\vspace{20pt}}
{
    ...
    \begin{spacing}{1.5}
        ...
        رویکرد ما در اینجا غیر تخصصی و عملی است به همین دلیل پیشنهاد ما کتاب \lr{Verth04} (نکته \hyperref[pnt:1.1]{\ref{pnt:1.1}.\arabic{chapter}}) است که کتابی اختصاصی برای ریاضیات بازی های سه بعدی/گرافیک است.
...
\label{sec:1.3}
{
    ...
    \begin{spacing}{1.5}
        ...
        بنابراین، معادله \hyperref[eqtn:1.4]{\ref{eqtn:1.4}.\arabic{chapter}} می گوید که حاصلضرب نقطه ای بین دو بردار، کسینوس زاویه بین آنها است که با بزرگی بردارها ضرب شده است.
        ...
        معادله \hyperref[eqtn:1.4]{\ref{eqtn:1.4}.\arabic{chapter}} برخی از ویژگی های هندسی مفید ضرب داخلی را در اختیار ما قرار می دهد:
        ...
        \begin{example}{exp:1.4}
            ...
            حالا ، معادله ی \hyperref[eqtn:1.4]{\ref{eqtn:1.4}.\arabic{chapter}} را برای حل $\theta$ اعمال میکنیم:
...
\label{sec:1.4}
{
    ...
    \begin{spacing}{1.5}
        ...
        \begin{example}{exp:1.6}
            فرض کنید $\textbf{u}=(2,1,3)$ و $\textbf{v}=(2,0,0)$ باشد. سپس $\textbf{w}=\textbf{u}\times\textbf{v}$ و $\textbf{z}=\textbf{v}\times\textbf{u}$ را محاسبه کنید و چک کنید که $\textbf{w}$ متعامد به $\textbf{u}$ و $\textbf{v}$ باشد. معادله ی \hyperref[eqtn:1.5]{\ref{eqtn:1.5}.\arabic{chapter}} را اعمال میکنیم: \\
            \begin{equation*}
                \centering
                \begin{split}
...
\label{subsec:1.6.9}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        کتابخانه ریاضی \lr{DirectX} تابع \lr{XMVector3NearEqual} را هنگام آزمایش برابری بردارها با پارامتر اپسیلون tolerance مجاز ارائه می دهد:
        \textbf{\vspace{6pt}}
...
\label{sec:1.8}
{
    ...
    \begin{spacing}{1.5}
        \begin{enumerate}[label=\textbf{\arabic*}.]
            ...
            \begin{hint}{hnt:1.5}
                \Large
                با $\norm{\textbf{u}}\norm{\textbf{v}}\sin\theta$ شروع کنید و از اتحاد مثلثاتی $\cos^2\theta+\sin^2\theta=1\Longrightarrow\sin\theta=\sqrt{\displaystyle 1-\cos^2\theta}$ استفاده کنید. سپس معادله ی \hyperref[eqtn:1.4]{\ref{eqtn:1.4}.\arabic{chapter}} را اعمال کنید.
            \end{hint}
            \\
