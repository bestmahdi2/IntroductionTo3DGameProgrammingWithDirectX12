...
\subsection{\textbf{روش های بارگیری و ذخیره سازی}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption=\rl{بارگیری}, firstline=54, lastline=62]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        ما از روش های زیر برای ذخیره داده ها از \texttt{XMVECTOR} در \texttt{XMFLOATn} استفاده می کنیم:
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption=\rl{ذخیره سازی}, firstline=65, lastline=73]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={Setter \& Getter}, firstline=76, lastline=84]{Codes/main.c}}
        \textbf{\vspace{6pt}}
    \end{spacing}
}
...
\subsection{\textbf{ارسال پارامتر}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, firstline=87, lastline=100]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={Parameter Passing}, firstline=103, lastline=110]{Codes/main.c}}
        \textbf{\vspace{6pt}}
       ...
       این تابع 6 پارامتر \texttt{XMVECTOR} را می گیرد، اما با رعایت قوانین عبور پارامتر، از \texttt{FXMVECTOR} برای سه پارامتر اول، \texttt{GXMVECTOR} برای چهارمین و \texttt{HXMVECTOR} برای پنجم و ششم استفاده می کند.
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={Parameter Passing}, firstline=113, lastline=120]{Codes/main.c}}
        \textbf{\vspace{6pt}}
...
\subsection{\textbf{بردارهای ثابت}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, firstline=123, lastline=137]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, firstline=140, lastline=155]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        همچنین می توانید با استفاده از \texttt{XMVECTORU32} یک \texttt{XMVECTOR} ثابت از داده های عدد صحیح ایجاد کنید:
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, firstline=158, lastline=161]{Codes/main.c}}
        \textbf{\vspace{6pt}}
    \end{spacing}
}
...
\subsection{\textbf{اپراتورهای سر بارگذاری شده}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={Operatings Overloading}, firstline=164, lastline=179]{Codes/main.c}}
        \textbf{\vspace{6pt}}
    \end{spacing}
}
...
\subsection{\textbf{متفرغه}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={Constants}, firstline=182, lastline=188]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        علاوه بر این، توابع درون خطی زیر را برای تبدیل بین رادیان و درجه تعریف می کند:
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++,  firstline=191, lastline=198]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        همچنین توابع \lr{min/max} را تعریف می کند:
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++,  firstline=201, lastline=203]{Codes/main.c}}
        \textbf{\vspace{6pt}}
    \end{spacing}
}
...
\subsection{\textbf{توابع setter}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++,  firstline=206, lastline=220]{Codes/main.c}}
        \textbf{\vspace{6pt}}
        برنامه زیر بیشتر این توابع را نشان می دهد:
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++,  firstline=223, lastline=263]{Codes/main.c}}
        \textbf{\vspace{6pt}}
