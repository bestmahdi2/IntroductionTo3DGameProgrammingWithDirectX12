...
\subsection{\textbf{توابع setter}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={d3d12book/Chapter 1 Vector Algebra/XMVECTOR/InitFunctions.cpp}, firstline=224, lastline=262]{Codes/main.c}}
        \textbf{\vspace{-30pt}}
        \begin{figure}[H]
            \centering
            \setlength{\belowcaptionskip}{-10pt}
...
\subsection{\textbf{توابع بردار}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={d3d12book/Chapter 1 Vector Algebra/XMVECTOR/xmvec3.cpp}, firstline=308, lastline=384]{Codes/main.c}}
        \textbf{\vspace{-30pt}}
        \begin{figure}[H]
            \centering
            \setlength{\belowcaptionskip}{-10pt}
...
\subsection{\textbf{خطای ممیز شناور}}
{
    ...
    \begin{spacing}{1.5}
        ...
        \textbf{\vspace{6pt}}
        \lr{\lstinputlisting[language=C++, caption={d3d12book/Chapter 1 Vector Algebra/XMVECTOR/tol.cpp}, firstline=396, lastline=428]{Codes/main.c}}
        \textbf{\vspace{-30pt}}
        \begin{figure}[H]
            \centering
            \setlength{\belowcaptionskip}{-10pt}
...
\section{\textbf{تمارین}}
{
    ...
    \begin{spacing}{1.5}
        \begin{enumerate}[label=\textbf{\arabic*}.]
            ...
            \textbf{\vspace{6pt}}
            \lr{\lstinputlisting[language=C++, caption={d3d12book/Chapter 1 Vector Algebra/XMVECTOR/VectorOps.cpp}, firstline=459, lastline=506]{Codes/main.c}}
            \textbf{\vspace{-40pt}}
            \begin{figure}[H]
                \centering
                \setlength{\belowcaptionskip}{-10pt}
