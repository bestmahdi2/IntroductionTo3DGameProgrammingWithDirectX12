...

{
    ...
    \begin{figure}[H]
        ...
        \caption*{\Large \href{https://learn.microsoft.com/en-us/windows/win32/direct3d12/directx-12-programming-guide}{\lr{https://learn.microsoft.com/en-us/windows/win32/direct3d12/directx-12-programming-guide}}}
    \end{figure}
...

{
    ...
    \begin{spacing}{1.5}
        ...
        در غیر این صورت بر روی \lr{\grayBox{View features}} کلیک کرده و نام آن را سرچ کرده و نصب کنید (شکل \ref{fig:3.Intro.4.1} - \ref{fig:3.Intro.4.2}).
...

{
    ...
    \begin{spacing}{1.5}
        ...
        اکنون پروژه در پنجره ی جدیدی باز میشود. از قسمت \lr{Solution Explorer} در سمت راست ، روی نام پروژه کلیک راست کرده و \lr{Properties} را بزنید (شکل \ref{fig:3.Intro.5.5}).
        ...
        سپس در قسمت سمت چپ پنجره زیر درخت \lr{Linker->System} را انتخاب کنید و در سمت راست \lr{SubSystem} را روی \lr{Windows (/SUBSYSTEM:WINDOWS)} قرار دهید (شکل \ref{fig:3.Intro.5.7}).
...

{
    ...
    \begin{spacing}{1.5}
        ...
        \begin{enumerate}
            ...
            \item {در قسمت \lr{Solution Explorer} بر روی نام پروژه کلیک راست کنید و \lr{Add->Exiting Item...} را انتخاب کنید.
            از پنجره ی باز شده به مسیر دایرکتوری \lr{Common} بروید و تمامی فایل ها با پسوند \lr{.h} و \lr{.cpp} را انتخاب کنید  (شکل \ref{fig:3.Intro.5.9.2} - \ref{fig:3.Intro.5.9.3}).
